 ...
 * compares it with the kit's own .kit-version and fails the build if they
 ...
 * reads .kit-version from the kit's main branch, which only changes when a
...
const REMOTE = "https://raw.githubusercontent.com/ko-di/forest-kit/main/.kit-version";
